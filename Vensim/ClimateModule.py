...
from pysd.py_backend.functions import if_then_else, incomplete, ramp
...
@component.add(
    name="Total Flux Biomass to CH4 Natural",
    comp_type="Constant",
    comp_subtype="Normal",
)
def total_flux_biomass_to_ch4_natural():
    return incomplete()


@component.add(
    name="Nature N2O Emissions",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"ch4_per_c": 1, "flux_biosphere_to_ch4_natural": 1},
)
def nature_n2o_emissions():
    return incomplete(ch4_per_c(), flux_biosphere_to_ch4_natural())


@component.add(name="CH4 per C", comp_type="Constant", comp_subtype="Normal")
def ch4_per_c():
    return incomplete()


@component.add(name="Flux Soil C to CH4", comp_type="Constant", comp_subtype="Normal")
def flux_soil_c_to_ch4():
    return incomplete()


@component.add(
    name="Flux Biosphere to CH4 Natural",
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"flux_soil_c_to_ch4": 1, "total_flux_biomass_to_ch4_natural": 1},
)
def flux_biosphere_to_ch4_natural():
    return incomplete(flux_soil_c_to_ch4(), total_flux_biomass_to_ch4_natural())
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"total_n2o_emissions": 1, "natural_n2o_emission": 1},
)
def total_n2o_emission():
    return total_n2o_emissions() + natural_n2o_emission()
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"total_ch4_emissions": 1, "natural_ch4_emissions": 1},
)
def total_ch4_emission():
    return total_ch4_emissions() + natural_ch4_emissions()
...
@component.add(
    ...
    comp_type="Auxiliary",
    comp_subtype="Normal",
    depends_on={"ch4_in_atmosphere": 1, "atmospheric_lifetime_of_ch4": 1, "coef": 1},
)
def total_ch4_breakdown():
    """
    Oxidation Losses
    """
    return ch4_in_atmosphere() / atmospheric_lifetime_of_ch4() * coef()
